...
export class InitialDatabase1657631530344 implements MigrationInterface {
    name = 'InitialDatabase1657631530344'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "feature" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "planId" integer, "fileData" character varying, CONSTRAINT "REL_0db8c6313683285102d7aa2f38" UNIQUE ("fileData"), CONSTRAINT "PK_03930932f909ca4be8e33d16a2d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "project" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "ownerId" integer NOT NULL, "planId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" integer, CONSTRAINT "REL_0e4667e99e3d673ae542835708" UNIQUE ("planId"), CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "application" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "scheduledAt" TIMESTAMP WITH TIME ZONE, "projectId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" integer, CONSTRAINT "PK_569e0c3e863ebdf5f2408ee1670" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "plan_files__file" ("planId" integer NOT NULL, "FileData" character varying NOT NULL, CONSTRAINT "PK_48c5ea74310b7b7f4f083ed527c" PRIMARY KEY ("planId", "FileData"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bd282013657508d9d571904178" ON "plan_files__file" ("planId") `);
        await queryRunner.query(`CREATE INDEX "IDX_6305fd2ff4a4539928386d4195" ON "plan_files__file" ("FileData") `);
        ...
        await queryRunner.query(`ALTER TABLE "feature" ADD CONSTRAINT "FK_c03677509c2d977cc22bf47f74e" FOREIGN KEY ("planId") REFERENCES "plan"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "feature" ADD CONSTRAINT "FK_0db8c6313683285102d7aa2f38e" FOREIGN KEY ("fileData") REFERENCES "_file"("data") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "plan_files__file" ADD CONSTRAINT "FK_bd282013657508d9d5719041789" FOREIGN KEY ("planId") REFERENCES "plan"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "plan_files__file" ADD CONSTRAINT "FK_6305fd2ff4a4539928386d41957" FOREIGN KEY ("FileData") REFERENCES "_file"("data") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "plan_files__file" DROP CONSTRAINT "FK_6305fd2ff4a4539928386d41957"`);
        await queryRunner.query(`ALTER TABLE "plan_files__file" DROP CONSTRAINT "FK_bd282013657508d9d5719041789"`);
        ...
        await queryRunner.query(`ALTER TABLE "feature" DROP CONSTRAINT "FK_0db8c6313683285102d7aa2f38e"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6305fd2ff4a4539928386d4195"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bd282013657508d9d571904178"`);
        await queryRunner.query(`DROP TABLE "plan_files__file"`);
