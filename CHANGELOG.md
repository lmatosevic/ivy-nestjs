...
### [0.5.8](https://github.com/Lujo5/ivy-nestjs/compare/v0.5.7...v0.5.8) (2022-12-21)


### Features

* add health ready check endpoint ([82a45cc](https://github.com/Lujo5/ivy-nestjs/commit/82a45cc18a887ef87969731a8aa18358d0a125b9))

### [0.5.7](https://github.com/Lujo5/ivy-nestjs/compare/v0.5.6...v0.5.7) (2022-12-19)

### [0.5.6](https://github.com/Lujo5/ivy-nestjs/compare/v0.5.5...v0.5.6) (2022-12-19)


### Features

* added type support for PartialType, ResourceController and ResourceResolver mixins ([0fd89fb](https://github.com/Lujo5/ivy-nestjs/commit/0fd89fb9b6bbf2bb26335957f50c572319e1d840))
...
* add day number variable and enabled multiple same variables in pattern ([001f4d1](https://github.com/Lujo5/ivy-nestjs/commit/001f4d13a6685a8312b66ae262bb6f9cfb78e1c6))
...
* add http body size limit config ([3d4b9fe](https://github.com/Lujo5/ivy-nestjs/commit/3d4b9fea7b86ebfa1e9d1ba192cca13efac1355f))
...
* add cache by modelName relations resolving ([a6635fb](https://github.com/Lujo5/ivy-nestjs/commit/a6635fba5b7d28627416eaa577f17811711ed28a))
* optimized auth service methods ([67ddb61](https://github.com/Lujo5/ivy-nestjs/commit/67ddb619c2771fa18e9dba75bc74e0391500236b))
...
* add protected service when finding authorized user ([0711329](https://github.com/Lujo5/ivy-nestjs/commit/07113294d9e18ce9588965355e42f10fa96bdea0))
...
* update cache relation keys name ([259a9f2](https://github.com/Lujo5/ivy-nestjs/commit/259a9f21cff8add323e2d7981b36082424064785))

### [0.3.46](https://github.com/Lujo5/ivy-nestjs/compare/v0.3.45...v0.3.46) (2022-09-05)


### Features

* add cache relation only expiration strategy ([149a005](https://github.com/Lujo5/ivy-nestjs/commit/149a005d8602c592e1160f217e501593f19c1649))
...
* change cache logging type ([9e5eb2c](https://github.com/Lujo5/ivy-nestjs/commit/9e5eb2c1d980ff5384a11dde7a50ec8f5e233162))
...
* fix file mime type simple rules validation ([a1ac6bc](https://github.com/Lujo5/ivy-nestjs/commit/a1ac6bcfdc6757904398aa4e5ca2efcc85d22836))
...
* enable both Public and Authorized decorators on any endpoint ([922c64c](https://github.com/Lujo5/ivy-nestjs/commit/922c64c8ae232d26d44c104645b2bf23bd179807))
...
* rename logger properties in resource services ([e04461c](https://github.com/Lujo5/ivy-nestjs/commit/e04461c1f93f4a440f2ba15b26c788030a9e9ee0))
...
* fix redis error when getting non-existing keys value ([6292107](https://github.com/Lujo5/ivy-nestjs/commit/6292107f9fc71a89dae77903dde18eb573923c01))
...
* increased query filter supported native types ([b1c7bfd](https://github.com/Lujo5/ivy-nestjs/commit/b1c7bfddcdf9c8e26d4c40497638226323d2bdc5))
...
* fix typeorm query parsing for nested bracket operators ([22d9f1f](https://github.com/Lujo5/ivy-nestjs/commit/22d9f1f0eacf0ffea7995e5967f2cca818dfd146))
...
* add check for email service import ([df942d5](https://github.com/Lujo5/ivy-nestjs/commit/df942d5c29981e2090448b987c60c6436d9692b8))
* add query params sanitization ([625c153](https://github.com/Lujo5/ivy-nestjs/commit/625c1530d0c258f9947058904b96c97ff3af9112))


### Bug Fixes

* **graphql:** fix graphql authorized endpoints user object resolving ([6817562](https://github.com/Lujo5/ivy-nestjs/commit/6817562c5cecdefc312dca6827db4ffff75e5928))

### [0.3.4](https://github.com/Lujo5/ivy-nestjs/compare/v0.3.3...v0.3.4) (2022-08-17)


### Bug Fixes

* fix eager relations resolving for internal service calls ([4747d98](https://github.com/Lujo5/ivy-nestjs/commit/4747d985a7147bd623e3974beb7e003e5da090ec))
